(function() {
  var AttachmentButton, __hasProp = {}.hasOwnProperty,
    ...
    AttachmentButton.prototype._initUploader = function() {
      ...
      createInput = (function(_this) {
        return function() {
          ...
          _this.input = $('<input type="file" name="upload_file" tabIndex="-1" multiple="true" />');
          if (_this.menu) {
      ...
      this.editor.uploader.on('beforeupload', (function(_this) {
        return function(e, file) {
          ...
          _this.editor.uploader.readImageFile(file.obj,
            function(img) {
              var imgPath, imgUrl;
              if (img) {
